...
public class DeleteOrganizationTest {
	...
	public void creatingOrganization() throws IOException, InterruptedException {
		...
		String orgName = excelLib.getDataFromExcelFile("Organization",7 ,2 )+jlib.getRandomNumber();
		...
		orginfopage.getOrganizationNameTextField().sendKeys(orgName);
		...
		wUtil.selectByVisibleText(op.getInDropdown(), "Organization Name");
		op.getSearchNowButton().click();
		
		Thread.sleep(3000);
		//store dynamic element and remove CRM_1218 do dynamic, select dynamic element and delete 
